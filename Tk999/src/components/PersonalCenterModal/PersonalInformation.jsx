...
const TabControl = ({ tabs, activeTab, setActiveTab, language }) => {
  return (
    <div className="w-1/5 hidden bg-[#00352f] lg:flex flex-col min-h-screen text-white shadow-md">
      <h3 className="text-center font-medium text-2xl py-4">
        {language === "en" ? "Personal Center" : "ব্যক্তিগত কেন্দ্র"}
      </h3>
      {tabs.map((tab) => (
        <button
          key={tab.id}
