        ...
        <Sidebar>
          ...
          <Menu>
            ...
            <SubMenu label="Frontend Control" icon={<FaSlidersH size={16} />}>
              ...
              <Link style={{ color: 'inherit', textDecoration: 'inherit' }} to="/RegistrationPageBanner">
                <MenuItem icon={<FaImage size={16} />} onClick={() => onMenuSelect('RegistrationPageBanner')}>
              ...
              <Link style={{ color: 'inherit', textDecoration: 'inherit' }} to="/AnimationBanner">
                <MenuItem icon={<FaImage size={16} />} onClick={() => onMenuSelect('Animation Banner')}>
                 Animation Banner
                </MenuItem>
              </Link>
